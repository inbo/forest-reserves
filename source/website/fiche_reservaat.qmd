...
carbon_by_plot <- read.csv2('carbon_by_plot.csv', header = TRUE, dec=',', sep=';')
dendro_by_diam_plot <- read.csv2('dendro_by_diam_plot.csv', header = TRUE, dec=',', sep=';')
dendro_by_diam_plot_species <- read.csv2('dendro_by_diam_plot_species.csv', header = TRUE, dec=',', sep=';')
dendro_by_plot <- read.csv2('dendro_by_plot.csv', header = TRUE, dec=',', sep=';')
logs_by_decay_plot <- read.csv2('logs_by_decay_plot.csv', header = TRUE, dec=',', sep=';')
logs_by_decay_plot_species <- read.csv2('logs_by_decay_plot_species.csv', header = TRUE, dec=',', sep=';')
regeneration_by_plot <- read.csv2('regeneration_by_plot.csv', header = TRUE, dec=',', sep=';')
regeneration_by_plot_height <- read.csv2('regeneration_by_plot_height.csv', header = TRUE, dec=',', sep=';')
regeneration_by_plot_height_species <- read.csv2('regeneration_by_plot_height_species.csv', header = TRUE, dec=',', sep=';')
plotinfo <- read.csv2('plotinfo.csv', header = TRUE, dec=',', sep=';')
all_names2 <- read.csv2('all_names2.csv', header = TRUE, dec=',', sep=';')
...
selected_reserve <- reserves[11]

 #[1] "Everzwijnbad"     "Withoefse heide"  "Wijnendalebos"    "Heirnisse"        "Jansheideberg"    "Bos Terrijst"    
 #[7] "Pruikemakers"     "Liedekerke"       "Sevendonck"       "Muizenbos"        "Kersselaerspleyn" "Ename"           
#[13] "De heide"         "Kluisbos"         "Kolmont"          "Zwaenepoel" 
...
Figure 1 and 2 give the total volume per period for the living, dead standing and dead lying trees, Figure 1 as absolute values and Figure 2 relative.
...
*Figure 1: Volume per period for the living, dead standing and dead lying trees.*
